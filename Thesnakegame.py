    ...
    def move(self):
        ...
        for i, c in enumerate(self.body):
            ...
            if p in self.turns:
                ...
                elif self.f == 0: c.move(c.dirnx,c.dirny)
...
def drawpause(surface):
    ...
    ds = basicfont.render(score, True, (255, 0, 0), (255, 255, 255))
    dsrect = ds.get_rect()
    dsrect.centerx = 400
    dsrect.centery = 520
...
def main():
    ...
    width = 500
    rows = 20
    win = pygame.display.set_mode((width, 540))
